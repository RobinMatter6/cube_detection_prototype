...
class Vision:
    ...
    def draw_rectangles_test(self, haystack_img, rectangles):
        ...
        # given a list of [x, y, w, h] rectangles and a canvas image to draw on, return an image with
    # all of those rectangles drawn, along with a big dot in the middle
    def draw_rectangles(self, haystack_img, rectangles):
        # these colors are actually BGR
        line_color = (0, 255, 0)
        dot_color = (0, 255, 0)  # green dot color
        line_type = cv.LINE_4
        ...
        for (x, y, w, h) in rectangles:
            ...
            # draw a big dot in the center
            cv.circle(haystack_img, (center_x, center_y), radius=6, color=dot_color, thickness=-1)
